    ...
    internal sealed class AuthenticationService : IAuthenticationService
    {
            ...
            UserManager<User> userManager, IOptionsMonitor<JwtConfiguration> configuration)
        {
            ...
            //  _configuration.Bind(_jwtConfiguration.Section,  _jwtConfiguration);
             //  _jwtConfiguration = _configuration.Value;// need restart the app to reload the config 
            _jwtConfiguration = _configuration.CurrentValue; //to enable live reloading for configuration
        }
